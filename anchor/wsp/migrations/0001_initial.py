# Generated by Django 2.2.12 on 2022-07-16 10:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recomend_crit', models.CharField(choices=[('RECOMMENDED', 'Recommended for Approval'), ('NOT RECOMMENDED', 'Not Recommended')], max_length=150)),
                ('vcapprove', models.CharField(choices=[('APPROVED', 'Approved'), ('NOT APPROVED', 'Not Approved')], max_length=150)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faculty', models.CharField(choices=[('FACULTY', 'Faculty'), ('HUMANITIES', 'Faculty of Humanities'), ('SMS', 'Faculty of Social and Management Sciences'), ('SCIENCE', 'Faculty of Science and Science Education')], default='FACULTY', max_length=50)),
